...
def preprocess_and_feature_engineer(train_df, test_df):
    ...
    for df in [train_processed, test_processed]:
        ...
        # --- NEW FEATURE (from scatterplot) ---
        # Create a simple binary flag for Grocery Stores
    ...
    for df in [train_processed, test_processed]:
        # --- NEW FEATURE (from scatterplot) ---
        # Create a flag for very high visibility items
        df['High_Visibility_Flag'] = (df['Item_Visibility'] > 0.19).astype(int)
        
        # --- NEW FEATURE (from scatterplot) ---
        # Create a ratio of visibility to price
...
if __name__ == '__main__':
  ...
  if train_df is not None and test_df is not None:
    ...
    ALL_POSSIBLE_ENGINEERED_FEATURES = [
      ...
      'Outlet_Type_Food_Ratio', 'Outlet_Type_Drinks_Ratio', 'Outlet_Type_NC_Ratio', 'is_Grocery_Store',
        'High_Visibility_Flag',
        'Visibility_per_MRP'
    ]
